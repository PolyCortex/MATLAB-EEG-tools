function M = randomPythagor_tree(n, nodeLevels, nodeAngles, nodeParents, Colormap)
...
colorNum = 0; 
for k = 1:numel(colorMat)
    testStr = strcmp(Colormap,colorMat{k});
    if testStr == 1
    colorNum = k;  
    end
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function H = Pythagor_tree_plot(D,d,ColorNum)
